...
public interface MatchRepository extends CrudRepository<Match, Long> {
  ...
  List<Match> getMatchesByTeamBetweenDates(@Param("teamName") String teamName, @Param("startDate") LocalDate startDate,
  ...
  // default List<Match> findMatchesOfTeamByYear(String teamName, LocalDate
  // startDate, LocalDate endDate) {
  // return getByTeam1AndDateBetweenOrTeam2AndDateBetweenOrderByDateDesc(teamName,
